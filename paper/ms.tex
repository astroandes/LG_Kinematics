...
simulated pairs with the observed LG {\bf at the 1-$\sigma$ level in
...
\item Values in parenthesis correspond to vector
  ...
  components of vector ${\bf x}$. {\bf The uncertainties correspond to
    1-$\sigma$ values.}  
...
\caption{Upper panels: 2D histograms of the radial and tangential
  ...
  calculated considering the halos as point masses. {\bf Left (right) panels
  ...
  the {\bf 1-$\sigma$ uncertainties} in observations. Equivalently, the contour
...
\begin{enumerate}
\item 
{\bf In columns 2 and 3 consistency is defined from 1-$\sigma$
...
The number of pairs compatible with LG observations {\bf at the
...
the full and the reduced sample of objects. {\bf These
...
between today's radial and tangential velocities, {\bf i.e. head-on
...
halos in the $\Lambda$CDM cosmology. {\bf Investigating this
...
{\bf The results presented in this Letter open a new window into the

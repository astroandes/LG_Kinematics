...
\end{center}
\vspace{1mm}
Note: the velocity uncertainties correspond to the minimal bin size required to
...
the full and the reduced sample of objects. {\bf These
  ...
  uncertainties. An agreement between both samples of simulated LGs and the observed LG is reached only at the 3-sigma level.}

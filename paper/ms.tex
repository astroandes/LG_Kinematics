...
\caption{Upper panels: 2D Histograms of the radial and tangential
  ...
  the observations {\bf with 1-$\sigma$ uncertainties}. The contour
  line in   the $e_{\rm tot}-l_{\rm orb}$ plane encloses $68\%$ of the
  Monte   Carlo generated points to estimated the uncertainties from
...
{\bf In columns 2 and 3 consistency is defined from 1-$\sigma$
  uncerainties for $v_{\rm r}$-$v_{\rm t}$, $e_{\rm tot}$-$l_{\rm
...
calculated within the same observational 1-$\sigma$ absolute uncertainty.
\end{enumerate}
\label{table:3}
\end{table*}

%Obs (full -3sigma) 127
%Theory (full 3sigma) 130
%Obs (reduced -3sigma) 11
%Theory (reduced 3sigma) 17
...
the full and the reduced sample of objects. {\bf This
  conclusions are valid at 1-$\sigma$ level in the observational
  uncertainties. Taking 3-$\sigma$ levels (i.e. uncertainties on the
  order of $\sigma_{\rm tan}=51$\kms and $\sigma_{\rm
    rad}=12$\kms the observational values are as likely as the
  preferred $\Lambda$CDM values, although only $\sim 6\%$ of the pairs
in the full and reduced samples would be consistent with observations.}
...
between today's radial and tangential velocities, {\bf i.e. head-on
  collisions of MW-like halos are not common in $\Lambda$CDM}.
...
halos in the $\Lambda$CDM cosmology. {\bf A thorough characterization
  of the small pair sample consistent with observations in terms
  of halo properties such as concentration, spin and place in the cosmic web
...
{\bf The results presented in this Letter open a new window into the
  ...
  context. This will continue to be studied within the CLUES project
  framework.}  
